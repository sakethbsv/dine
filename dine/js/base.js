...
$(document).ready(function() {
	...
	for (j = 0, k = orderList.length; j < k; j++) {
		...
		$itemTable.append(
			" <tr id='" + orderList[j] + "'>" + "<td>" + data[3] + "</td> &nbsp;&nbsp;&nbsp;<td>" + data[0] + "</td>" + "&nbsp;&nbsp;&nbsp;<td>" + data[5] + "</td>" + "&nbsp;&nbsp;&nbsp;<td>" + data[2] + "</td>" + "&nbsp;&nbsp;&nbsp;<td class='waited'>" + waited + "</td>" + "&nbsp;&nbsp;&nbsp;<td><a class='notify' href='#'>Notify</a></td>" + "&nbsp;&nbsp;&nbsp;<td><a class='seat' href='#'>Seat</a></td>" + "&nbsp;&nbsp;&nbsp;<td>" + data[4] + "</td>" + "<td><a class='remove' href='#'>X</a></td></tr>"
		);
